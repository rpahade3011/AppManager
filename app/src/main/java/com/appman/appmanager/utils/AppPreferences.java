...
public class AppPreferences {
    ...
    public String getCustomPath() {
        return sharedPreferences.getString(KeyCustomPath, Utility.getDefaultAppFolder().getPath());
    }
    ...
    public String getSmsPath(){
        return sharedPreferences.getString(KeySmsPath, Utility.getDefaultSmsFolder().getPath());
    }
    ...
    public String getContactsPath(){
        return sharedPreferences.getString(KeyContactsPath, Utility.getDefaultContactsFolder().getPath());
    }
