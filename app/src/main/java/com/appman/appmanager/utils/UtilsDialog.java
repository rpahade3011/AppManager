...
import com.appman.appmanager.materialdesign.SnackBar;
...
public class UtilsDialog {
     ...
     */
    public static SnackBar showSnackbar(Activity activity,
                                        String text, @Nullable String buttonText,
                                        @Nullable final File file, Integer style) {
        SnackBar snackBar;
