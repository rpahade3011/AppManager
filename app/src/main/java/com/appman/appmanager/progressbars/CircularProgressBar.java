package com.appman.appmanager.progressbars;
...
public class CircularProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            // Value
            progress = typedArray.getFloat(R.styleable.CircularProgressBar_circle_progress, progress);
            max = typedArray.getFloat(R.styleable.CircularProgressBar_circle_max, max);
            // StrokeWidth
