package com.appman.appmanager.widget.textcounter;
...
import com.appman.appmanager.widget.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.appman.appmanager.widget.textcounter.formatters.DecimalFormatter;
import com.appman.appmanager.widget.textcounter.formatters.IntegerFormatter;
import com.appman.appmanager.widget.textcounter.formatters.NoFormatter;
...
public class CounterView extends TextView {
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            ...
            final int type = typedArray.getInteger(R.styleable.CounterView_counter_type, 0);
            switch(type) {
                case 0:
